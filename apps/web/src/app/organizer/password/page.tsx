...
export default function OrganizerPasswordPage() {
  ...
  const onSubmit = async (data: ChangePasswordDTO) => {
    ...
    try {
      ...
      setStatusMsg({ type: "success", text: "Organizer password changed successfully." });
      reset();
    } catch (err: unknown) {
    ...
    >
      ...
      >
        ...
        <p style={{ color: "var(--color-muted)", margin: 0, fontSize: "0.92rem" }}>
          Protect your organizer account with a high-security password.
        </p>
      </div>
