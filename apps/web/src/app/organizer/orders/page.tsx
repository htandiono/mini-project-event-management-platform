          ...
          {filteredOrders.map((order) => (
            ...
            >
              <div>
                ...
                <h4 style={{ margin: "0 0 0.2rem 0", fontSize: "1.05rem", color: "var(--color-ink)" }}>
                  {order.event.name}
                </h4>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", minWidth: "140px" }}>
                {order.paymentProof ? (
                  <button
                    type="button"
                    onClick={() => setSelectedProof(order.paymentProof?.imageUrl || order.paymentProof?.fileUrl || "")}
                    className="button"
                    style={{
                      background: "rgba(23, 109, 101, 0.1)",
                      color: "var(--color-teal)",
      ...
      {viewingAttendeesEventId && (
        ...
        >
          ...
          >
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.9rem" }}>
                  ...
                  <tbody>
                    {attendeesData.items.map((att, idx) => (
                      ...
                      >
                        <td style={{ padding: "0.75rem", fontWeight: "600" }}>{att.customerName}</td>
            ...
            <div style={{ textAlign: "right", borderTop: "1px solid var(--color-line)", paddingTop: "1rem" }}>
              <button
                type="button"
                onClick={() => setViewingAttendeesEventId(null)}
                className="button"
